/**
 * JS runtime mirror for keeper (tsx/node import).
 * Keep signatures aligned with shared/tradeMath.ts.
 */
export function calcLiquidationPrice(side, entryPrice, leverage, mmr = 0.01) {
...
export function calcTpSlPrices(side, entryPrice, leverage, takeProfitPct, stopLossPct, mode) {
