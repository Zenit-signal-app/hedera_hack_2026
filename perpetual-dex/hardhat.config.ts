...
const config: HardhatUserConfig = {
  ...
  networks: {
    hederaMainnet: {
      ...
      chainId: 295,
      /** Prefer HEDERA_MAINNET_PRIVATE_KEY_1 for testing, else dedicated mainnet key, else PRIVATE_KEY. */
      accounts: accountsFromEnv(
        process.env.HEDERA_MAINNET_PRIVATE_KEY_1,
        process.env.HEDERA_MAINNET_PRIVATE_KEY || process.env.PRIVATE_KEY
      ),
    },
    hederaTestnet: {
