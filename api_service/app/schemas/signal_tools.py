...
class ADXDataPoint(CustomBaseModel):
    ...
    trend: str = Field("", description="Computed trend for the latest entry; empty for others.")
...
class PSARDataPoint(CustomBaseModel):
    ...
    trend: str = Field("", description="Calculated trend comparing the latest two psar_type values.")
