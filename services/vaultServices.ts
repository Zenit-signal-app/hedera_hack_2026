...
export const vaultApi = {
   ...
   */
  getVaultsByStatus: async (status: VaultStatus = 'active', chain_id?: ChainIdParam): Promise<VaultsResponse> => {
   ...
   */
  getVaultInfo: async (id: string, chain_id?: ChainIdParam): Promise<VaultInfo> => {
   ...
   */
  getVaultValues: async (id: string, options?: VaultValuesRequest, chain_id?: ChainIdParam): Promise<VaultValuesResponse> => {
   ...
   */
  getVaultPositions: async (id: string, options?: PositionsRequest, chain_id?: ChainIdParam): Promise<PositionsResponse> => {
   ...
   */
  getVaultStats: async (id: string, chain_id?: ChainIdParam): Promise<VaultStats> => {
   ...
   */
  getUserVaultEarnings: async (options: UserVaultEarningsRequest, chain_id?: ChainIdParam): Promise<UserVaultEarningsResponse> => {
   ...
   */
  getUserVaultEarningInfo: async (id: string, walletAddress: string, chain_id?: ChainIdParam): Promise<UserVaultEarningInfoResponse> => {
   ...
   */
  getUserVaultTransactions: async (options: UserVaultTransactionsRequest, chain_id?: ChainIdParam): Promise<UserVaultTransactionsResponse> => {
