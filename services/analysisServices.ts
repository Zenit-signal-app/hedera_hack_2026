...
import { ApiResponse, PaginationParams } from "@/types/transaction";
...
export const getListToken = async (params: TokensParams): Promise<Token[]> => {
	try {
...
export const fetchTransactions = async (params: PaginationParams): Promise<ApiResponse> => {
    try {
